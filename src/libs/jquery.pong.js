...
(function($) {
    ...
    {
        obj.css({"position":"relative","border-style":"solid","border-width":opts.border_width});
        ...
        obj.append($("<input>").css({"background-color":"transparent","color":obj.css("color"),"border":0,"position":"absolute","text-align":"center","width":100,"font-size":60,"font-weight":"bold","left":(obj.width()/2)-120}).attr("type","text").attr("id",obj.attr("id")+"_score1").val(0));
        obj.append($("<input>").css({"background-color":"transparent","color":obj.css("color"),"border":0,"position":"absolute","text-align":"center","width":100,"font-size":60,"font-weight":"bold","left":(obj.width()/2)+20}).attr("type","text").attr("id",obj.attr("id")+"_score2").val(0));
    }
        ...
        $("#"+$this.attr("id")+"_ball").animate({"left":x,"top":y},speed,"linear",function(){
            ...
            if (dx==-1) {
                ...
                if (y > y_min && y < y_max) {
                    ...
                    if ($("#"+$this.attr("id")+"_score2").val() >= 1) {
                        $this.trigger('pongGameOver', {status: 'lost'});
                    }
                ...
                if (y > y_min && y < y_max) {
                    ...
                    if ($("#"+$this.attr("id")+"_score1").val() >= 1) {
                        $this.trigger('pongGameOver', {status: 'won'});
                    }
                }
            }
    ...
    $.fn.pong.defaults = {
        ...
        "speed": 1200                    // Vitesse de la balle
    };
